...
<ul class="navbar-nav" id="navbar-nav">
    ...
    @can('user_management_access')
        <li class="nav-item">
            <a class="nav-link menu-link {{ request()->is('admin/permissions*') ? '' : 'collapsed' }} {{ request()->is('admin/roles*') ? '' : 'collapsed' }} {{ request()->is('admin/users*') ? 'c-show' : '' }}" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
